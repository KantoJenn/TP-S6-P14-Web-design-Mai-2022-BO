...
%>
<head>
    <title>Modification <%=articles.get(0).getTitre()%> - BLOG IA</title>
    ...
    <div class="content">
        <div class="col-12">
            <form action="<%=request.getContextPath()%>/Modifier" method="POST">
                <input type="hidden" name="id" value="<%=articles.get(0).getIdArticle()%>">
                <input type="hidden" name="daty" value="<%=articles.get(0).getDateAjout()%>">
                <div class="form-group">
                    <label>Titre</label>
                    <input type="text" class="form-control" id="titre" name="titre" value="<%=articles.get(0).getTitre()%>">
                </div>
                <div class="form-group">
                    <label>Description</label>
                    <textarea name="description"><%=articles.get(0).getDescription()%></textarea>
                </div>
